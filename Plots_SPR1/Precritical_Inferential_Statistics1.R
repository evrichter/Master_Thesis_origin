...
p1 <- p1 + labs(x="Region", y="Z-values", title = "Single Plausibility + GPT-2 Surprisal + Pre-critical RT") 
p1 <- p1 + theme(legend.position="none", legend.text=element_text(size=7), legend.title=element_text(size=7), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=8)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
...
p2 <- p2 + labs(x="Region", y="Z-values", title = "Single Plausibility + LeoLM Surprisal + Pre-critical RT") 
p2 <- p2 + theme(legend.position="none", legend.text=element_text(size=7), legend.title=element_text(size=7), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=8)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
...
p3 <- p3 + labs(x="Region", y="Z-values", title = "Average Plausibility + GPT-2 Surprisal + Pre-critical RT") 
p3 <- p3 + theme(legend.position="none", legend.text=element_text(size=7), legend.title=element_text(size=7), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=8)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
...
p4 <- p4 + theme(legend.position="none", legend.text=element_text(size=7), legend.title=element_text(size=7), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=8)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
p4 <- p4 + geom_point(data = Effect_sizes, aes(2, -9.5, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p4 <- p4 + geom_point(data = Effect_sizes, aes(3, -9.5, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p4 <- p4 + geom_point(data = Effect_sizes, aes(4, -9.5, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p4 <- p4 + geom_point(data = Effect_sizes, aes(1, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p4 <- p4 + geom_point(data = Effect_sizes, aes(2, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p4 <- p4 + geom_point(data = Effect_sizes, aes(3, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p4 <- p4 + geom_point(data = Effect_sizes, aes(4, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p4 
p4 
...
p_legend2 <- p_legend2 + scale_color_manual(name="Coefficients", labels=c( "Target Plausibility", "Pre-critical RT3", "Distractor Surprisal"), values=c("#FF00FF", "#FF0000", "#00FFFF"))
p_legend2 <- p_legend2 + labs(x="Region", y="Z-values", title = "Average Plausibility + LeoLM Surprisal + Pre-critical RT") 
...
combined_plot_with_legend <- grid.arrange(empty_row, combined_plot, legend, legend2, nrow = 4, heights = c(0.2, 9,0.5, 0.3))
combined_plot_with_legend <- grid.text(caption, x = 0.207, y = 0.98, just = "center", gp = gpar(fontsize = 15))
