...
p1 <- p1 + labs(x="Region", y="Z-values", title = "Single Plausibility + GPT-2 Surprisal") 
...
p2 <- p2 + labs(x="Region", y="Z-values", title = "Single Plausibility + LeoLM Surprisal") 
...
p3 <- p3 + labs(x="Region", y="Z-values", title = "Average Plausibility + GPT-2 Surprisal") 
...
p4 <- p4 + labs(x="Region", y="Z-values", title = "Average Plausibility + LeoLM Surprisal") 
...
p_legend <- p_legend + scale_color_manual(name="Coefficients", labels=c("Target Plausibility", "Distractor Surprisal"), values=c("#FF00FF", "#00FFFF"))
