...
p4 <- p4 + theme_minimal()
p4 <- p4 + scale_color_manual(name="Coefficients", labels=c( "Average Plausibility", "LeoLM Surprisal"), values=c("#FF00FF", "#00FFFF"))
p4 <- p4 + labs(x="Region", y="Z-values", title = "Inferential Statistics") 
