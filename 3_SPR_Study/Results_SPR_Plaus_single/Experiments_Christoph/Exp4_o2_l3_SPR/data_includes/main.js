...
PennController("instructions",
    ...
    newCanvas(200,150)
        ...
        .print()
    ,
    newText("<p>In diesem Experiment gibt es einsgesamt drei Blocks. Nach jedem Block erfahren Sie, wie gut Sie die Aufgabe bearbeitet haben. Zwischen den Blocks haben Sie Zeit um eine kurze Pause zu machen.</p>")
