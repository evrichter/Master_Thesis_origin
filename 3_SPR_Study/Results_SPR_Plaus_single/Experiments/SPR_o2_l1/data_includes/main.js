...
Sequence("consent", "consent2", "demographics", "instructions1", "instructions2", "instructions3",
...
PennController("instructions1",
    newHtml("instructions1", "instructions01.html")
        .print()
    ,
    newButton("Fortfahren")
        .center()
...
PennController("instructions2",
    newHtml("instructions2", "instructions02.html")
        .print()
    ,
    newButton("Fortfahren")
        .center()
...
PennController("instructions3",
    newHtml("instructions3", "instructions03.html")
        .print()
    ,
...
Template("SPR_practice.csv", row =>
  newTrial("practice",
    ...
    newController("DashedSentence", {s: row.Sentence, mode:"self-paced reading", display: "in place", blankText: "#"})
        ...
        .remove()
    ,
    newController("practice_accept",'AcceptabilityJudgment',
        {
        s: ""
        ,
        as: [
...
Template("SPR_o2_l1_b1.csv", row =>
  newTrial("block1",
    ...
    newController("DashedSentence", {s: row.Sentence, mode:"self-paced reading", display: "in place", blankText: "#"})
        ...
        .remove()
    ,
    newController("block1_accept",'AcceptabilityJudgment',
        {
        s: ""
        ,
        as: [
...
Template("SPR_o2_l1_b2.csv", row =>
  newTrial("block2",
    ...
    newController("DashedSentence", {s: row.Sentence, mode:"self-paced reading", display: "in place", blankText: "#"})
        ...
        .remove()
    ,
    newController("block2_accept",'AcceptabilityJudgment',
        {
        s: ""
        ,
        as: [
...
Template("SPR_o2_l1_b3.csv", row =>
  newTrial("block3",
    ...
    newController("DashedSentence", {s: row.Sentence, mode:"self-paced reading", display: "in place", blankText: "#"})
        ...
        .remove()
    ,
    newController("block3_accept",'AcceptabilityJudgment',
        {
        s: ""
        ,
        as: [
