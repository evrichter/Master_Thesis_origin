...
p1 <- ggplot(Effect_sizes, aes(x = factor(Region, levels = c("Pre-critical", "Critical", "Spillover", "Post-spillover")), 
                               y = Z_value, color = Estimate, group = Estimate)) + geom_point(shape = 4, size = 3.5, stroke = 0.8) + geom_line(linewidth=0.5) + ylim (-12, 35)
...
p1 <- p1 + labs(x="Region", y="Z-values", title = "Plausibility + GPT-2 Surprisal + Pre-critical RT") 
p1 <- p1 + theme(legend.position="none", legend.text=element_text(size=7), legend.title=element_text(size=7), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=10)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
p1 <- p1 + geom_point(data = Effect_sizes, aes(2, -9.5, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
...
p2 <- p2 + labs(x="Region", y="Z-values", title = "Plausibility + LeoLM Surprisal + Pre-critical RT") 
p2 <- p2 + theme(legend.position="none", legend.text=element_text(size=7), legend.title=element_text(size=7), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=10)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
p2 <- p2 + geom_point(data = Effect_sizes, aes(3, -9.5, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p2 <- p2 + geom_point(data = Effect_sizes, aes(4, -9.5, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p2 <- p2 + geom_point(data = Effect_sizes, aes(1, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p2 <- p2 + geom_point(data = Effect_sizes, aes(2, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p2 <- p2 + geom_point(data = Effect_sizes, aes(3, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p2 <- p2 + geom_point(data = Effect_sizes, aes(4, -12, group = Estimate), size = 2, shape = 19, color = "#FF0000")
p2  
...
p_legend <- ggplot(Effect_sizes, aes(x = factor(Region, levels = c("Pre-critical", "Critical", "Spillover", "Post-spillover")), 
                               y = Z_value, color = Estimate, group = Estimate)) + geom_point(shape = 4, size = 3.5, stroke = 0.8) + geom_line(linewidth=0.5) + ylim (-5, 35)
p_legend <- p_legend + geom_hline(yintercept=0, linetype=2)
p_legend <- p_legend + theme_minimal()
p_legend <- p_legend + scale_color_manual(name="Z-values", labels=c("Target Plausibility", "PrecritRT", "Distractor Surprisal"), values=c("#FF00FF", "#FF0000", "#00FFFF"))
p_legend <- p_legend + labs(x="Region", y="Z-values", title = "Inferential Statistics") 
p_legend <- p_legend + theme(legend.position="bottom", legend.text=element_text(size=10), legend.title=element_text(size=10), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=11)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
p_legend 
...
p_legend2 <- ggplot(Effect_sizes, aes(x = factor(Region, levels = c("Pre-critical", "Critical", "Spillover", "Post-spillover")), 
                                     y = Z_value, color = Estimate, group = Estimate)) + geom_point(shape = 4, size = 3.5, stroke = 0.8) 
p_legend2 <- p_legend2 + geom_hline(yintercept=0, linetype=2)
p_legend2 <- p_legend2 + theme_minimal()
p_legend2 <- p_legend2 + scale_color_manual(name="Coefficients", labels=c("Target Plausibility", "PrecritRT", "Distractor Surprisal"), values=c("#FF00FF", "#FF0000", "#00FFFF"))
p_legend2 <- p_legend2 + labs(x="Region", y="Z-values", title = "Inferential Statistics") 
p_legend2 <- p_legend2 + theme(legend.position="bottom", legend.text=element_text(size=10), legend.title=element_text(size=10), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14), axis.text.x = element_text(size = 8)) + theme(plot.title = element_text(size=11)) + theme(plot.margin = margin(t = 0.5, r = 0.2, b = 0, l = 0.2, unit = "cm"))
...
combined_plot_with_legend <- grid.arrange(empty_row, combined_plot, legend, legend2, nrow = 4, heights = c(0.2, 9,0.7, 0.7))
combined_plot_with_legend <- grid.text(caption, x = 0.205, y = 0.97, just = "center", gp = gpar(fontsize = 15))
