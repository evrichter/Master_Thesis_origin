...
p1 <- ggplot(Effect_sizes, aes(x = factor(Region, levels = c("Pre-critical", "Critical", "Spillover", "Post-spillover")), 
                              y = Z_value, color = Estimate, group = Estimate)) + geom_point(shape = 4, size = 3.5, stroke = 0.8) + geom_line(linewidth=0.5) + ylim (-6.2, 6)
...
p1 <- p1 + labs(x="Region", y="Z-values", title = "Plausibility + GPT-2 Surprisal") 
...
p1 <- p1 + geom_point(data = Effect_sizes, aes(1, -6.2, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p1 <- p1 + geom_point(data = Effect_sizes, aes(2, -6.2, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p1 <- p1 + geom_point(data = Effect_sizes, aes(3, -6.2, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p1 <- p1 + geom_point(data = Effect_sizes, aes(4, -6.2, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p1
...
p2 <- p2 + labs(x="Region", y="Z-values", title = "Plausibility + LeoLM Surprisal") 
...
p2 <- p2 + geom_point(data = Effect_sizes, aes(2, -6.2, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p2 <- p2 + geom_point(data = Effect_sizes, aes(3, -6.2, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p2 <- p2 + geom_point(data = Effect_sizes, aes(4, -6.2, group = Estimate), size = 2, shape = 19, color = "#FF00FF")
p2
#############################################################################
...
combined_plot_with_legend <- grid.text(caption, x = 0.195, y = 0.97, gp = gpar(fontsize = 15))
combined_plot_with_legend

setwd("~/Downloads/Master_Thesis/Plots_SPR2/")
# Save the combined plot
ggsave("Combined_Plot_Coefficients_Inferential_Statistics.pdf", combined_plot_with_legend, device = "pdf")
