...
p1 <- p1 + labs(x="Region", y="SPR2 Coefficients", title = "Plausibility + GPT-2 Surprisal") 
...
p2 <- p2 + labs(x="Region", y="SPR2 Coefficients", title = "Plausibility + LeoLM Surprisal") 
...
combined_plot_with_legend <- grid.text(caption, x = 0.166, y = 0.97, gp = gpar(fontsize = 15))
