...
p1 <- p1 + labs(x="Region", y="logRT", title = "Estimated RTs") 
p1 <- p1 + theme(legend.position="bottom", legend.text=element_text(size=7), legend.title=element_text(size=7), axis.title.x = element_text(size = 14), axis.title.y = element_text(size = 14)) 
p1 
