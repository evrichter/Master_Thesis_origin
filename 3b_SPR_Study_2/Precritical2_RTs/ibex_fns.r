...
get_reads <- function(
    ...
    dt$Region <- ifelse(dt$WordNum == dt$Critical, "Critical", 
                 ...
                 ifelse(dt$WordNum == (dt$Critical-1), "Precrit",
                 ifelse(dt$WordNum == (dt$Critical-2), "Precrit_2", 
                 ifelse(dt$WordNum == (dt$Critical-3), "Precrit_3", 
                 ifelse(dt$WordNum == (dt$Critical-4), "Main_Verb", "noncritical")))))))
